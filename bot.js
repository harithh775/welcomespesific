...
bot.on("guildMemberAdd", async member => {
      ...
      let BG = db.get(`${member.guild.id}.Config.Welcome.Background`);
      if (!BG) BG = "https://cdn.discordapp.com/attachments/733961963771527169/734692144513810442/23424234234234234.jpg";
...
bot.on("guildMemberRemove", async member => {
      ...
      let BG = db.get(`${member.guild.id}.Config.Welcome.Background`);
      if (!BG) BG = "https://cdn.discordapp.com/attachments/733961963771527169/734692142563196998/123123123123123123123.jpg";
...
bot.on("guildMemberAdd", async member => {
      ...
      let BG = db.get(`${member.guild.id}.Config.Welcome.Background`);
      if (!BG) BG = "https://cdn.discordapp.com/attachments/707786216300347502/734692028415213568/3242343242342432.jpg";
...
bot.on("guildMemberRemove", async member => {
      ...
      let BG = db.get(`${member.guild.id}.Config.Welcome.Background`);
      if (!BG) BG = "https://cdn.discordapp.com/attachments/707786216300347502/734692034690023474/2332423424243242432.jpg";
